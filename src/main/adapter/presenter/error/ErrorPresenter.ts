...
@injectable()
export default class ErrorPresenter implements IPresenter<ErrorResponse<ApplicationError>,ErrorViewModel<any>>{
    present(response: ErrorResponse<ApplicationError>) {
        console.log('======== ERROR PRESENTER =========')
